  ...
  <body>
    ...
    <div class="container">
      ...
      <form method="post" name="myform" class="form-horizontal" 
      		action="<%=request.getContextPath()%>/categoria/atualizar">
      		...
      		<div class="form-group">
      			...
      			<div>
      				<input type="text" name="codCategoria" id="codCategoria" value="${item.codCategoria}"
      		...
      		<div class="form-group">
      			<div class="col-sm-offset-2 col-sm-10">
					...
					<a href="<%=request.getContextPath()%>/categoria/listarCategoria" class="btn btn-default">Voltar</a>      			
      			</div>
      		</div>
      </form>
    </div>
